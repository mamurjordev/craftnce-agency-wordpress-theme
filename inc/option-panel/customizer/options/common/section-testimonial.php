<?php
     ...
     */
    $wp_customize->add_setting('craftnce_show_testimonials_section_setting', array(
        'default'           => 1,
        'capability'        => 'edit_theme_options',
        'transport'         => 'refresh',
        'type'              => 'theme_mod',
    ...
    $wp_customize->add_control('craftnce_show_testimonials_section_ctrl', array(
        'label'             =>  __('Show testimonials section', 'craftnce'),
        'section'           =>  'craftnce_page_testimonials',
        'settings'          =>  'craftnce_show_testimonials_section_setting',
        'type'              =>  'checkbox'
    ));

<?php
    $wp_customize->add_section( 'craftnce_page_testimonials', array(
    ...
    $wp_customize->add_control('craftnce_show_home_testimonials_section_ctrl', array(
        'label'             =>  __('Show in home page.', 'craftnce'),
        'section'           =>  'craftnce_page_testimonials',
        'settings'          => 'craftnce_show_home_testimonials_section_setting',
        'type'              =>  'checkbox'
    ));

    $wp_customize->add_setting('craftnce_show_about_testimonials_section_setting', array(
        'default'           => 1,
        'capability'        => 'edit_theme_options',
        'transport'         => 'refresh',
        'type'              => 'theme_mod',
    ...
    $wp_customize->add_control('craftnce_show_about_testimonials_section_ctrl', array(
        'label'             =>  __('Show in about page.', 'craftnce'),
        'section'           =>  'craftnce_page_testimonials',
        'settings'          =>  'craftnce_show_about_testimonials_section_setting',
        'type'              =>  'checkbox'
    ));
     ...
     */
    $wp_customize->add_setting('craftnce_testimonials_heading_setting', array(
    ...
    $wp_customize->add_control('craftnce_testimonials_heading_ctrl', array(
        'label'             =>  __('Heading', 'craftnce'),
        'section'           =>  'craftnce_page_testimonials',
        'settings'          =>  'craftnce_testimonials_heading_setting',
        'type'              =>  'text'
    ));
     ...
     */
    $wp_customize->add_setting('craftnce_testimonials_subheading_setting', array(
        'default'           => 'testimonial',
        'capability'        => 'edit_theme_options',
        'transport'         => 'refresh',
        'type'              => 'theme_mod',
    ...
    $wp_customize->add_control('craftnce_testimonials_subheading_ctrl', array(
        'label'             =>  __('Sub-heading', 'craftnce'),
        'section'           =>  'craftnce_page_testimonials',
        'settings'          =>  'craftnce_testimonials_subheading_setting',
        'type'              =>  'text'
    ));
    
    // testimonials Items
    $wp_customize->add_setting( 'craftnce_testimonials_item_settings', array(
        'capability'            => 'edit_theme_options',
        'transport'             => 'refresh',
        'type'                  => 'theme_mod',
        'sanitize_callback'     => 'customizer_repeater_sanitize',
    ));
    $wp_customize->add_control( new Customizer_Repeater( $wp_customize, 'craftnce_testimonials_items_control', array(
        'label'                                             =>  esc_html__('Testimonials Item','craftnce'),
        'section'                                           =>  'craftnce_page_testimonials',
        'settings'                                          =>  'craftnce_testimonials_item_settings',
    ...
    function repeater_title_labels( $string, $id, $control ) {
        if ( $id === 'craftnce_testimonials_items_control' ) {
